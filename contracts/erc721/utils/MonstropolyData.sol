...
contract MonstropolyData is IMonstropolyData, AccessControlProxyPausable, UUPSUpgradeableByRole, CodificationConverter { 
    ...
    function getValueFromGen(string calldata gen, uint index) public view returns(uint256) {
    ...
    /// @inheritdoc IMonstropolyData
    function updateLength(uint256 _genLength) public onlyRole(DEFAULT_ADMIN_ROLE) {
