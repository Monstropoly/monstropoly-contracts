...
contract MonstropolyFarming is AccessControlProxyPausable, UUPSUpgradeableByRole {
    ...
    function depositFrom(address account, uint256 amount) public whenNotPaused {
      ...
      require(tokenInterface.transferFrom(account, address(this), amount), "MonstropolyFarming: deposit transfer failed");
    ...
    function withdraw(uint256 amount) public whenNotPaused returns (uint256) {
      ...
      require(amount <= user.amount, "MonstropolyFarming: user has not enough staking balance");
