...
const DEPLOYER_ADDR = '0x3ce02BaBCec05fCe7045658A114ad4A3beE4B362'
...
async function main() {
    ...
    const ID = ethers.utils.id('STAKING')
    const Factory = await ethers.getContractFactory('MonstropolyStaking')
