...
async function main() {
    ...
    console.log("hardhat verify --network bsctestnet", deployer.address)
    ...
    console.log("hardhat verify --network bsctestnet", factoryAddress, factoryImpl.address, emptyInitializeCalldata)
    ...
    console.log("hardhat verify --network bsctestnet", magicBoxesAddress, magicBoxesImp, emptyInitializeCalldata)
    ...
    // await myMagicBoxes.updateBoxSupply(2, 1000, { gasPrice: 10000000000 })
    // await myMagicBoxes.updateBoxSupply(3, 1000, { gasPrice: 10000000000 })
    // await myMagicBoxes.updateBoxSupply(4, 1000, { gasPrice: 10000000000 })
    // await myMagicBoxes.updateBoxSupply(5, 1000, { gasPrice: 10000000000 })
    ...
    console.log("hardhat verify --network bsctestnet", nftStakingAddress, implementation3[0], emptyInitializeCalldata)
    ...
    for (let i = 0; i < N_BOXES; i++) {
        ...
        console.log("hardhat verify --network bsctestnet", ticketAddress, ticketsImp.address, ticketsInitializeCalldata)
