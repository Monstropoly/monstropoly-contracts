...
const FACTORY_ADDR = '0xAf77a4CD20dA46AfBA6b10b802500a17cf11d0A3'
const DATA_ADDR = '0x7F55424BF259A2fB9D5f2b15c5fE9476D5a7C3FB'
...
async function main() {
    ...
    //     let nft = await factoryContract.tokenOfId(log.args.tokenId)
    ...
    let filterTokenId = factoryContract.filters.Mint(null, null, 0)
    let logs = await factoryContract.queryFilter(filterTokenId, -4000, "latest")
